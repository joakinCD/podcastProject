      ...
      <View style={{flex:1,flexDirection:'row'}}>
          ...
          <View style={{flex:1}}>
            <View style={{margin:10,padding:10,shadowColor: "#000",shadowOffset: {width: 0,height: 2},shadowOpacity: 0.25,shadowRadius: 3.84,elevation: 5}}>
              <Text style={{fontSize: 16,fontWeight:'bold'}}>Episodios: {podcast.totalEpisodios}</Text>
            </View>
            <View style={{height:700,alignItems:'center',justifyContent:'center',margin:10,padding:10,shadowColor: "#000",shadowOffset: {width: 0,height: 2},shadowOpacity: 0.25,shadowRadius: 3.84,elevation: 5}}>
              <View style={{width:'100%',borderBottomWidth:1,borderColor:'grey',padding:10,flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                <Text style={{fontWeight:'bold',fontSize: 16,flex:1}}>Título</Text>
                <Text style={{fontWeight:'bold',fontSize: 16,width:100}}>Fecha</Text>
                <Text style={{fontWeight:'bold',fontSize: 16,width:80}}>Duración</Text>
              </View>
              <FlatList
                  style={{width:'100%'}}
