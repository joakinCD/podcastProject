  ...
  return (
    <NavigationContainer >
        <Stack.Navigator
            ...
            headerTitle: () => {
              return(
                <Pressable onPress={abrirPrincipal}>
                  <Text
                    style={{fontSize: 16,fontWeight:'bold',color:'#327cbc'}}>Podcaster
                  </Text>
                </Pressable>
              )
            },
          ...
          <Stack.Screen name="vistaPrincipal" component={VistaPrincipal} options={{title:'Podcaster',gestureEnabled: false}}  />
          <Stack.Screen name="vistaDetallesPodcast" component={VistaDetallesPodcast} options={{title:'Podcaster',gestureEnabled: false}}  />
          <Stack.Screen name="vistaDetallesEpisodio" component={VistaDetallesEpisodio} options={{title:'Podcaster',gestureEnabled: false}}  />
        </Stack.Navigator>
      </NavigationContainer>
  );
};
